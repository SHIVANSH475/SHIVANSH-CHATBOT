...
@Mukesh.on_message(filters.command(["cstart",f"start@{BOT_USERNAME}"]))
...
#  alive
@Mukesh.on_message(filters.command(["cping","alive"], prefixes=["","+", "/", "-", "?", "$", "&","."]))
